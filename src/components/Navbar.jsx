    ...
    <>
      <div className="w-full flex justify-between items-center font-semibold ">
        ...
        <div className="flex items-center gap-4">
            ...
            <p className="bg-black py-1 px-3 rounded-3xl texr-[15px] cursor-pointer">Install App</p>
            <p className="bg-purple-500 text-black w-7 h-7 flex rounded-full items-center justify-center ">A</p>
        </div>
      </div>
